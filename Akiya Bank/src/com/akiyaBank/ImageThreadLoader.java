...
/*
 * This Activity is used for Image Loading
 */
public class ImageThreadLoader {
	...
	public static Bitmap readBitmapFromNetwork( URL url ) {
		...
		try {
			...
			System.out.println("*************Bad ad URL"+e.toString());
		} catch (IOException e) {
			System.out.println("******************Could not get remote ad image"+e.toString());
		} finally {
			try {
				if( is != null )
					is.close();
				...
				Log.w("ERROR:::", "Error closing stream.");
			}
		}
		//Log.e("*********", "--5");
		return bmp;
